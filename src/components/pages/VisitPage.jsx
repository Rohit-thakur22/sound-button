            ...
            <main className="hidebar dark:bg-[#212D3D] w-full relative flex min-h-screen flex-col items-center">
                ...
                <div className="bg-white md:mt-[100px] dark:bg-[#212D3D] w-full md:shadow-lg md:rounded-3xl md:max-w-[70%] lg:max-w-[50%] h-full md:border dark:border-[#212D3D] mx-auto mt-[60px] relative">
                    <div className="text-center mb-6 mt-6">
                        <h2 className="text-4xl dark:text-white font-semibold">{sharedData ? sharedData.name : userData && userData.name}</h2>
                        <p className='mt-2 text-gray-500 dark:text-gray-300'>Creator | Sound Effect Button</p>
                    </div>
                    <svg className='rounded-b-3xl -mt-[100px]' xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 2400 800" opacity="0.76">
                        <defs>
                            <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="sssurf-grad">
                                <stop stopColor="hsl(208, 77%, 50%)" stopOpacity="1" offset="0%" />
                                <stop stopColor="hsl(208, 74%, 93%)" stopOpacity="1" offset="100%" />
                            </linearGradient>
                        </defs>
                        <g fill="url(#sssurf-grad)" transform="matrix(1,0,0,1,2.0377197265625,277.198543548584)">
                            <path d="M-10,10C117.08333333333334,32.708333333333336,347.9166666666667,125.66666666666667,600,119C852.0833333333333,112.33333333333333,950,-18.875,1200,-22C1450,-25.125,1550,123.375,1800,104C2050,84.625,2222.9166666666665,-176.66666666666669,2400,-115C2577.0833333333335,-53.33333333333333,3254.1666666666665,188.54166666666669,2650,400C2045.8333333333335,611.4583333333333,156.25,795.8333333333334,-500,900" transform="matrix(1,0,0,1,0,90)" opacity="0.05" />
                            <path d="M-10,10C117.08333333333334,32.708333333333336,347.9166666666667,125.66666666666667,600,119C852.0833333333333,112.33333333333333,950,-18.875,1200,-22C1450,-25.125,1550,123.375,1800,104C2050,84.625,2222.9166666666665,-176.66666666666669,2400,-115C2577.0833333333335,-53.33333333333333,3254.1666666666665,188.54166666666669,2650,400C2045.8333333333335,611.4583333333333,156.25,795.8333333333334,-500,900" transform="matrix(1,0,0,1,0,180)" opacity="1.00" />
                        </g>
                    </svg>
                </div>
                        ...
                        <>
                            {filters === 'created' ? (
                                <div className="md:w-[90%] grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 my-8 gap-5">
                                    {createdSoundsOfUser && createdSoundsOfUser.length > 0 ? createdSoundsOfUser.map((sound) => (
                                        <Soundbox
                                            key={sound.id}
                                            id={sound.id}
                                            visitShow={true}
                                        ...
                                        <div className='w-full flex items-center justify-center col-span-full'>
                                            <p className="text-center text-lg text-gray-500">No created sound</p>
                                        </div>
                                    )}
                                </div>
                            ) : (
                                <div className="md:w-[90%] grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 my-8 gap-5">
                                    {favouriteSounds && favouriteSounds.length > 0 ? favouriteSounds.map((sound) => (
                                        <Soundbox
                                            key={sound.id}
                                            id={sound.id}
                                            visitShow={true}
                                        ...
                                        <div className='w-full flex items-center justify-center col-span-full'>
                                            <p className="text-center text-lg text-gray-500">No favourite sound</p>
                                        </div>
                                    )}
                                </div>
                            )}
